        ...
        <div class="container">
            ...
            <?php if(isset($_SESSION['username'])) : ?>
                <div class="connected-infos-container">
                    <p class="paragraph">Take advantage of this space to manage all your urls. Activate, deactivate, delete, rename and have access to all the shortened urls that you have converted. With URLights, get acces to the shortest url you could have and manage them as you wish. </p>
            ...
            <p onclick="copyToClipboard('.url-to-copy')"><?php if(isset($_SESSION['returnUrl'])) echo 'Your link : ' .  '<input class="url-to-copy copy-input" type="text" value="' . $_SESSION['returnUrl'] . '"/>';?></p>
        </div>
    </section>
    </div>
